 ...
 * @subpackage Patterns_Edd/Patterns_Edd_Api_Settings
 */
 ...
 *
 * @see Patterns_Edd_Api
 */
if ( ! class_exists( 'Patterns_Edd_Api_Settings' ) ) {

	/**
	 * Patterns_Edd_Api_Settings
	 *
	 * @see WP_REST_Settings_Controller
	 * @package Patterns_Edd
	 * @since 1.0.0
	 */
	class Patterns_Edd_Api_Settings extends Patterns_Edd_Api {
		 ...
		 */
		public function run() {
			$this->type      = 'patterns_edd_api_settings';
		...
		public function get_item( $request ) {
			...
			$saved_options = patterns_edd_get_options();
		...
		public function update_item( $request ) {
			...
			if ( is_wp_error( rest_validate_value_from_schema( $params, $schema ) ) ) {
				return new WP_Error(
					...
					sprintf( __( 'The %s property has an invalid stored value, and cannot be updated to null.', 'patterns-edd' ), PATTERNS_EDD_OPTION_NAME ),
					array( 'status' => 500 )
				);
			}
		...
		public function get_settings_schema() {
			$setting_properties = apply_filters(
				'patterns_edd_options_properties',
				array(
...
/**
 * Return instance of  Patterns_Edd_Api_Settings class
 *
 * @since 1.0.0
 *
 * @return Patterns_Edd_Api_Settings
 */
function patterns_edd_api_settings() { //phpcs:ignore
	return Patterns_Edd_Api_Settings::get_instance();
}
patterns_edd_api_settings()->run();
