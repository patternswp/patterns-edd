 ...
 * @subpackage Patterns_Edd/includes/api
 */
 ...
 */
if ( ! class_exists( 'Patterns_Edd_Api' ) ) {
	 ...
	 * @since 1.0.1
	 */
	class Patterns_Edd_Api extends WP_REST_Controller {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'patterns-edd' ), '1.0.0' );
		}
