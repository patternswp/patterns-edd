...
?>
<!-- wp:group {"style":{"border":{"style":"solid","width":"1px"},"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"backgroundColor":"quaternary","borderColor":"tertiary","layout":{"type":"default"}} -->
<div class="wp-block-group has-border-color has-tertiary-border-color has-quaternary-background-color has-background" style="border-style:solid;border-width:1px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"default"}} -->
...
<!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading"><?php esc_html_e( '99', 'patterns-edd' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<p class="has-tertiary-color has-text-color has-large-font-size"><s><?php esc_html_e( '149', 'patterns-edd' ); ?></s></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"2px","bottom":"2px","left":"var:preset|spacing|10","right":"var:preset|spacing|10"},"blockGap":"0"},"elements":{"link":{"color":{"text":"var:preset|color|default"}}},"border":{"radius":"50px"}},"backgroundColor":"secondary","textColor":"default","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-default-color has-secondary-background-color has-text-color has-background has-link-color" style="border-radius:50px;padding-top:2px;padding-right:var(--wp--preset--spacing--10);padding-bottom:2px;padding-left:var(--wp--preset--spacing--10)"><!-- wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Purchase Now', 'patterns-edd' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
