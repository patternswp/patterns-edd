...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"0"}},"backgroundColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-base-background-color has-background">
    ...
    <div class="wp-block-columns alignwide are-vertically-aligned-top" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
        ...
        <h6 class="wp-block-heading has-text-align-left has-default-color has-text-color has-link-color"><?php esc_html_e( 'Contact Info', 'patterns-edd' ); ?></h6>
        <!-- /wp:heading -->
        ...
        <p class="has-text-align-left has-default-color has-text-color has-medium-font-size" style="font-style:normal;font-weight:300"><?php esc_html_e( 'Got Question? Call us 24/7', 'patterns-edd' ); ?></p>
        <!-- /wp:paragraph -->

        <!-- wp:paragraph {"className":"pwp-txt-dec-non","style":{"elements":{"link":{"color":{"text":"var:preset|color|default"},":hover":{"color":{"text":"var:preset|color|secondary"}}}}},"textColor":"default","fontSize":"large"} -->
        <p class="pwp-txt-dec-non has-default-color has-text-color has-link-color has-large-font-size"><a href="<?php echo esc_url( 'tel:(629) 555-0129' ); ?>"><?php esc_html_e( '(629) 555-0129', 'patterns-edd' ); ?></a></p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:group -->

        <!-- wp:paragraph {"className":"pwp-txt-dec-non","style":{"elements":{"link":{":hover":{"color":{"text":"var:preset|color|secondary"}},"color":{"text":"var:preset|color|default"}}}}} -->
        <p class="pwp-txt-dec-non has-link-color"><a href="<?php echo esc_url( 'mailto:support@demo.com' ); ?>"><?php esc_html_e( 'support@demo.com', 'patterns-edd' ); ?></a></p>
        <!-- /wp:paragraph -->

        <!-- wp:paragraph {"align":"left","style":{"elements":{"link":{"color":{"text":"var:preset|color|default"}}}},"textColor":"default"} -->
        <p class="has-text-align-left has-default-color has-text-color has-link-color"><?php esc_html_e( '785 15h Street, Office 478 Berlin, De 81566 6391 Elgin St. Celina, 10299', 'patterns-edd' ); ?></p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:group --></div>
        <!-- /wp:column -->
        ...
        <h6 class="wp-block-heading has-text-align-left has-default-color has-text-color"><?php esc_html_e( 'Category', 'patterns-edd' ); ?></h6>
        <!-- /wp:heading -->

        <!-- wp:navigation {"textColor":"default","overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"fontSize":"x-small","layout":{"type":"flex","orientation":"vertical"}} -->
            <!-- wp:navigation-link {"label":"<?php esc_html_e( 'Travel', 'patterns-edd' ); ?>","url":"#"} /-->

            <!-- wp:navigation-link {"label":"<?php esc_html_e( 'Sports', 'patterns-edd' ); ?>","url":"#"} /-->

            <!-- wp:navigation-link {"label":"<?php esc_html_e( 'Health & Beauty', 'patterns-edd' ); ?>","url":"#"} /-->

            <!-- wp:navigation-link {"label":"<?php esc_html_e( 'Lifestyle', 'patterns-edd' ); ?>","url":"#"} /-->
        <!-- /wp:navigation -->
        ...
        <div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":6,"textColor":"default"} -->
        <h6 class="wp-block-heading has-text-align-left has-default-color has-text-color"><?php esc_html_e( 'Quick Links', 'patterns-edd' ); ?></h6>
        <!-- /wp:heading -->
    ...
    <div class="wp-block-group alignwide">
        ...
        <!-- wp:pattern {"slug":"patterns-edd/copyright"} /-->

        <!-- wp:group {"layout":{"type":"flex","flexWrap":"wrap"}} -->
        <div class="wp-block-group">
            
            <!-- wp:paragraph {"align":"left","textColor":"tertiary","fontSize":"x-small"} -->
            <p class="has-text-align-left has-tertiary-color has-text-color has-x-small-font-size"><?php esc_html_e( 'Safe Payments', 'patterns-edd' ); ?></p>
            <!-- /wp:paragraph -->
...
<!-- wp:pattern {"slug":"patterns-edd/scroll-to-top-button"} /-->
