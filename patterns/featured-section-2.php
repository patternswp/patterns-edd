 ...
 * Slug: patterns-edd/featured-section-2
 * Categories: edd,featured
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Check Out Our Newest Products', 'patterns-edd' ); ?></h3>
<!-- /wp:heading -->


<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e( 'Lorem Ipsum is simply dummy text of the printing', 'patterns-edd' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->



<!-- wp:query {"query":{"postType":"download","inherit":false,"perPage":8},"align":"wide","layout":{"type":"constrained"}} -->
