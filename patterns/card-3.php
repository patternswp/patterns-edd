...
<!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading"><?php esc_html_e( '49', 'patterns-edd' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<p class="has-tertiary-color has-text-color has-large-font-size"><s><?php esc_html_e( '99', 'patterns-edd' ); ?></s></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
