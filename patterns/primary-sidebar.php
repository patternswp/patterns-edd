 ...
 * Slug: patterns-edd/primary-sidebar
 * Categories: posts
...
<div class="wp-block-group">
    <!-- wp:pattern {"slug":"patterns-edd/search-form"} /-->
    <!-- wp:pattern {"slug":"patterns-edd/latest-posts"} /-->
    <!-- wp:pattern {"slug":"patterns-edd/latest-comments"} /-->
</div>
<!-- /wp:group -->
